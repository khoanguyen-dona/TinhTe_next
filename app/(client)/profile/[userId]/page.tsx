...
const page = () => {
  ...
  return (
    <div className=' h-auto'>
        <div className='flex flex-col px-2  mt-16  '>
            {/* user info */}
            ...
            {/* <div className={`flex flex-col justify-center items-center  bg-red-100  w-full  py-8 px-2   `}>     */}
            
                <div className='relative'>
                    <Image width={100} height={100} src={user?.img as string||'/user.png'} className='w-30 h-30 object-cover rounded-full' alt='avatar' />
                    {
                        user?.isAdmin ?
                        <div className='absolute -bottom-4 left-7 p-1 px-2 bg-orange-300 rounded-lg font-bold text-white  text-center '>Admin</div>
                        : user?.isReporter ?
                ...
                <div className=' '>
                    <div className='flex justify-end'>
                        <div 
                            ...
                            className={`bg-blue-100 gap-1 p-2 mt-2 rounded-lg text-blue-500 flex justify-center 
                                    items-center hover:cursor-pointer font-semibold ${currentUser?._id === userId?'hidden':''}`}>
                            {mailLoading ?
                    ...
                    <div className='flex flex-col mt-2'>
                        ...
                        {posts?.map((post,index)=>(
                            <div className='w-full flex flex-col md:flex-row space-y-2 mt-8' key={index}>
                                <div className='w-full  md:w-[200px]'>
                                    <Image src={post?.thumbnail} className='w-full md:w-40 h-70 md:h-30 rounded-lg object-cover' alt='post thumbnail' width={100} height={70} />
                                </div>
